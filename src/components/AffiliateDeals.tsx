...
export function AffiliateDeals() {
  const deals = [
    {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {deals.map((deal, index) => (
            ...
            >
              ...
              <a
                href={deal.link}
                className="inline-flex items-center text-white bg-gradient-to-r from-cyan-500 to-indigo-500 px-4 py-2 rounded-lg hover:from-cyan-400 hover:to-indigo-400 transition-colors"
              >
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            className="bg-gradient-to-r from-purple-900/50 to-indigo-900/50 rounded-xl p-8 relative overflow-hidden"
          >
          ...
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            className="bg-gradient-to-r from-cyan-900/50 to-blue-900/50 rounded-xl p-8 relative overflow-hidden"
          >
