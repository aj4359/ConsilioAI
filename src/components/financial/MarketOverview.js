...
function MarketOverview() {
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Promise.all(WATCHED_SYMBOLS.map(function (symbol) { return (0, financial_1.getStockData)(symbol); }))];
                    case 1:
                        data_1 = _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Failed to fetch stocks data:', error_1);
                        return [2 /*return*/, []];
    ...
    }), stocksData = _a.data, isLoading = _a.isLoading;
    if (isLoading) {
    ...
    return (<div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
      <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative">
        ...
        <div className="space-y-4">
          {stocksData === null || stocksData === void 0 ? void 0 : stocksData.map(function (_a, index) {
            ...
            return (<framer_motion_1.motion.div key={symbol} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.1 }} whileHover={{ scale: 1.02 }} className="bg-slate-700/50 rounded-lg p-4 border border-slate-600/50 relative overflow-hidden group">
                {/* Hover Effect */}
                <framer_motion_1.motion.div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity" animate={{
                    opacity: [0, 0.5, 0],
                }} transition={{
                    duration: 2,
                    repeat: Infinity,
                ...
                <div className="flex justify-between items-center relative z-10">
                  ...
                  <div className="text-right">
                    ...
                    <p className={"text-sm flex items-center ".concat(isPositive ? 'text-green-400' : 'text-red-400')}>
