...
exports.getForexRates = getForexRates;
...
function getStockData(symbol) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                // Return mock data
                return [2 /*return*/, Promise.resolve(mockStockData[symbol] || {
...
function getMarketNews() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, Promise.resolve(mockNews)];
        });
    });
}
// Mock crypto prices
var mockCryptoPrices = {
...
function getCryptoPrices() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, Promise.resolve(mockCryptoPrices)];
        });
    });
}
// Mock forex rates
...
function getForexRates() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, Promise.resolve(mockForexRates)];
        });
    });
}
// Mock economic indicators
var mockEconomicIndicators = {
...
function getEconomicIndicators() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, Promise.resolve(mockEconomicIndicators)];
        });
    });
}
